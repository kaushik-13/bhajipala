...
<body>
        ...
        <div class="navbar-nav ml-auto">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item" href="login.php">Login as Vendor</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <section id="hero">
        <div class="hero-container">
            <h1>Welcome to BhajiPala</h1>
            <p>Your journey to smart trade starts here.<br> 
                Easily connect with farmers and vendors to get the best deals on fresh produce.
            </p>
    ...
    <section id="products">
        <div class="container">
            <div class="card-deck">
                <div class="card">
                    <img class="card-img-top" src="images/carrot.jpeg" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card">
                    <img class="card-img-top" src="images/corn.jpg" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card">
                    <img class="card-img-top" src="images/wheat.jpg" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card">
                    <img class="card-img-top" src="images/garlic.jpg" alt="Card image cap">
                    <div class="card-body">
    ...
    <div class="container1">
        <div class="about-us">
            <h1>About Us</h1>
            <p>We help folks love, heal, understand, and move their bodies—so they can be happier, healthier humans.</p>
        </div>
        <div class="content">
            <div class="text">
                <h2>We're here to get as many people <span>moving</span> as possible.</h2>
                <p>Not just people that are already fit, but all people. We offer a more accessible and sustainable alternative to the popular "No, pain. No gain." mantra.</p>
                <p>We don't think exercise should be associated with pain at all. Gives it a bad name. Exercise is medicine. When done right, it not only alleviates pain, but it protects against it.</p>
            </div>
        </div>
    </div>
