        ...
        <div class="navbar-nav ml-auto">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" style="margin-left: 0px; margin-right: 0px;" href="F-register.html">Register as Farmer</a>
                    <a class="dropdown-item" style="margin-left: 0px; margin-right: 0px;" href="registration.php">Register as Vendor</a>
                    <a class="dropdown-item" style="margin-left: 0px; margin-right: 0px;" href="d_settings.html">settings</a>
                    ...
                    <div class="container">
                        <div class="card-deck">
                            ...
                            <div class="container">
                                ...
                                $holding_sql = "SELECT * FROM `crop` WHERE `CID` IN (SELECT `CID` FROM `bid` WHERE `DID`='$DID' AND `status`='active');";
                                    ...
                                    if (mysqli_num_rows($holding_sql_result) > 0) {
                                        ...
                                        while ($hold_row = mysqli_fetch_assoc($holding_sql_result)) {
                                            echo "<div class='card col-md-3' style='padding-right:0px; padding-left:0px;'>
                                                        ...
                                                        <div class='card-body'>
                                                        <h5 class='card-title'>{$hold_row['name']}</h5>
                                                        <p class='card-text'>Base price - {$hold_row['base price']}</p>
                                                        </div> 
                                                        <div class='card-footer'>
                                                        <a href='crp_details.php?id={$hold_row['CID']}&did={$DID}' style='color:white;text-decoration:none;'><button class='btn btn-sm btn-primary'>View details</button></a>
                                                        </div>
                                                    </div>";
                                        }
